...
# 1st Floor
room_1108 = DoorNode([], 0, the_void, 'e', (511, 857))
room_1105 = DoorNode([], 0, the_void, 's', (676, 964))
room_1102 = DoorNode([], 0, the_void, 's', (813, 964))
room_1401 = DoorNode([], 0, the_void, 'n', (1136, 885))
room_1402 = DoorNode([], 0, the_void, 's', (1280, 965))
room_1409 = DoorNode([], 0, the_void, 'n', (1300, 888))
room_1202 = DoorNode([], 0, the_void, 'w', (435, 676))
