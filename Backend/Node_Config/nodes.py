...
l3 = CornerNode([], "3 Left 3rd")
r3 = CornerNode([], "3 Right 3rd")

n3e = CornerNode([], "3 North Extension 3rd Floor")
s3e = CornerNode([], "3 South Extension 3rd Floor")

l4 = CornerNode([], "4 Left 4th")
r4 = CornerNode([], "4 Right 4th")
...
atl2 = CornerNode([], "2 Arts Building Top Left 2nd")
abl2 = CornerNode([], "2 Arts Building Back Left 2nd")
abr2 = CornerNode([], "2 Arts Building Back Right 2nd")
atr2 = CornerNode([], "2 Arts Building Top Right 2nd")
amb2 = CornerNode([], "2 Arts Building Middle Bottom 2nd")
amt2 = CornerNode([], "2 Arts Building Middle Top 2nd")
...
stair2_f1 = StairNode([], "w", "1 Stair 2 1st Floor", (387, 921))
stair2_f2 = StairNode([], "w", "2 Stair 2 2nd Floor", (414, 930))
stair2_f3 = StairNode([], "w", "3 Stair 2 3rd Floor")
stair2_f4 = StairNode([], "w", "4 Stair 2 4th Floor")
stair2_f5 = StairNode([], "w", "5 Stair 2 5th Floor")

stair3_f1 = StairNode([], "w", "1 Stair 3 1st Floor", (503, 639))
stair3_f2 = StairNode([], "w", "2 Stair 3 2nd Floor", (500, 712))
stair3_f3 = StairNode([], "w", "3 Stair 3 3rd Floor")
stair3_f4 = StairNode([], "w", "4 Stair 3 4th Floor")
...
stair8_f1 = StairNode([], "e", "1 Stair 8 1st Floor", (1302, 808))
stair8_f2 = StairNode([], "e", "2 Stair 8 2nd Floor", (1272, 848))
stair8_f3 = StairNode([], "e", "3 Stair 8 3rd Floor")
stair8_f4 = StairNode([], "e", "4 Stair 8 4th Floor")

stair9_f1 = StairNode([], "e", "1 Stair 9 1st Floor", (1293, 1108))
stair9_f2 = StairNode([], "e", "2 Stair 9 2nd Floor", (1272, 1058))
stair9_f3 = StairNode([], "e", "3 Stair 9 3rd Floor")
stair9_f4 = StairNode([], "e", "4 Stair 9 4th Floor")
stair9_f5 = StairNode([], "e", "5 Stair 9 5th Floor")

stair11_f0 = StairNode([], "e", "Stair 11 Basement")
stair11_f1 = StairNode([], "e", "1 Stair 11 1st Floor")
stair11_f2 = StairNode([], "e", "2 Stair 11 2nd Floor")
...
stair14_f2 = StairNode([], "w", "2 Stair 14 2nd Floor")
...
stair17_f2 = StairNode([], "e", "2 Stair 17 2nd Floor")
