...
fr1 = CornerNode([], "Front Right 1st", (1241, 940))
fl1 = CornerNode([], "Front Left 1st", (497, 808))
bc1 = CornerNode([], "Back Center 1st")
br1 = CornerNode([], "Back Right 1st", (1244, 498))
bl1 = CornerNode([], "Back Left 1st", (643, 395))

fc2 = CornerNode([], "Front Center 2nd")
fr2 = CornerNode([], "Front Right 2nd", (1244, 938))
fl2 = CornerNode([], "Front Left 2nd", (491, 808))
bc2 = CornerNode([], "Back Center 2nd")
br2 = CornerNode([], "Back Right 2nd", (1244, 503))
bl2 = CornerNode([], "Back Left 2nd", (645, 394))

n2e = CornerNode([], "North Extension 2nd Floor", (352, 664))
c2e = CornerNode([], "Center Extension 2nd Floor", (323, 768))
s2e = CornerNode([], "South Extension 2nd Floor", (280, 860))

l3 = CornerNode([], "Left 3rd")
r3 = CornerNode([], "Right 3rd")

n3e = CornerNode([], "North Extension 3rd Floor")
s3e = CornerNode([], "South Extension 3rd Floor")
...
stair1_f1 = StairNode([], "n", "Stair 1 1st Floor", (913, 839))
stair1_f2 = StairNode([], "n", "Stair 1 2nd Floor")
stair1_f3 = StairNode([], "n", "Stair 1 3rd Floor")
stair1_f4 = StairNode([], "n", "Stair 1 4th Floor")

stair2_f1 = StairNode([], "w", "Stair 2 1st Floor", (387, 921))
stair2_f2 = StairNode([], "w", "Stair 2 2nd Floor", (414, 930))
stair2_f3 = StairNode([], "w", "Stair 2 3rd Floor")
stair2_f4 = StairNode([], "w", "Stair 2 4th Floor")
stair2_f5 = StairNode([], "w", "Stair 2 5th Floor")

stair3_f1 = StairNode([], "w", "Stair 3 1st Floor", (503, 639))
stair3_f2 = StairNode([], "w", "Stair 3 2nd Floor", (500, 712))
stair3_f3 = StairNode([], "w", "Stair 3 3rd Floor")
stair3_f4 = StairNode([], "w", "Stair 3 4th Floor")

stair5_f1 = StairNode([], "n", "Stair 5 1st Floor", (642, 312))
stair5_f2 = StairNode([], "n", "Stair 5 2nd Floor", (651, 344))

stair6_f1 = StairNode([], "n", "Stair 6 1st Floor", (1274, 422))
stair6_f2 = StairNode([], "n", "Stair 6 2nd Floor", (1255, 449))

stair8_f1 = StairNode([], "e", "Stair 8 1st Floor", (1302, 808))
stair8_f2 = StairNode([], "e", "Stair 8 2nd Floor", (1272, 848))
stair8_f3 = StairNode([], "e", "Stair 8 3rd Floor")
stair8_f4 = StairNode([], "e", "Stair 8 4th Floor")

stair9_f1 = StairNode([], "e", "Stair 9 1st Floor", (1293, 1108))
stair9_f2 = StairNode([], "e", "Stair 9 2nd Floor", (1272, 1058))
...
room_2414 = DoorNode([], 0, the_void, "s")
room_2415 = DoorNode([], 0, the_void, "e")
room_2412 = DoorNode([], 0, the_void, "n")
room_2411 = DoorNode([], 0, the_void, "e")

room_2135 = DoorNode([], 0, the_void, "w")
room_2132 = DoorNode([], 0, the_void, "w")
room_2133 = DoorNode([], 0, the_void, "s")
room_2134 = DoorNode([], 0, the_void, "n")
...
room_3411 = DoorNode([], 0, the_void, "s")
room_3412 = DoorNode([], 0, the_void, "e")
room_3409 = DoorNode([], 0, the_void, "n")
room_3408 = DoorNode([], 0, the_void, "e")

room_3121 = DoorNode([], 0, the_void, "w")
room_3120 = DoorNode([], 0, the_void, "w")
room_3119 = DoorNode([], 0, the_void, "w")
room_3118 = DoorNode([], 0, the_void, "w")
room_3117 = DoorNode([], 0, the_void, "n")
room_3122 = DoorNode([], 0, the_void, "s")
...
room_2606 = DoorNode([], 0, the_void, "w")
room_2607 = DoorNode([], 0, the_void, "e")
room_2608 = DoorNode([], 0, the_void, "n")
room_2609 = DoorNode([], 0, the_void, "e")
room_2611 = DoorNode([], 0, the_void, "s")
room_2612 = DoorNode([], 0, the_void, "s")
room_2613 = DoorNode([], 0, the_void, "s")
room_2614 = DoorNode([], 0, the_void, "s")
room_2615 = DoorNode([], 0, the_void, "n")
room_2616 = DoorNode([], 0, the_void, "s")
room_2617 = DoorNode([], 0, the_void, "e")
room_2618 = DoorNode([], 0, the_void, "e")
room_2619 = DoorNode([], 0, the_void, "w")
room_2620 = DoorNode([], 0, the_void, "e")
room_2621 = DoorNode([], 0, the_void, "s")
